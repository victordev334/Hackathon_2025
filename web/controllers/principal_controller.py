...
class UsuarioModel:
    ...
    def login(self, username, password):
        ...
        Si las contraseñas están en texto plano, la comparación es directa.
        Si las contraseñas están en hash, se debe usar una librería como bcrypt o passlib.
        """
        if not self.conn:
        ...
        try:
            ...
            # Si usas un hash, deberías comparar aquí con bcrypt o passlib (comentado aquí para ejemplo):
